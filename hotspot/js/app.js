...
var viewModel = function() {
  ...
  var map;
  var service;
  var defaultNeighborhood = 'SugarLand, Texas';
  var mapMarkers   = [];
  var infowindow;
  ...
  // initial map is set to SugarLand, Texas 
  ...
  function getNeighborhoodInformation(locationDetail) {
    ...
    var clientID      = '&client_id=W02F3EMAVHI1QNK2G2BKSLZ0HIGH1GEDQFGLUTBYF0LHDSTD';
    var clientSecret  = '&client_secret=WYYLJNLAE0DIAO4V1NYFDSBQHPWZTQUB0JPEUS1LRKWL0YT5&v=YYYYMMDD&v=20151218';
    ...
    .error(function() { 
      ...
      alert('Error retrieving Foursquare Popular Places');
    });
  }
